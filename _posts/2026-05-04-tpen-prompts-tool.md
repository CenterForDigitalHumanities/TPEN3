...
When opened via the Transcription Interface, TPEN hands the tool a context-filled payload so prompt generation is instant. All data generated by the AI is done so through TPEN Services, meaning it is proper linked open data. It is W3C Web Annotation and IIIF compliant.

---
title: "TPEN 3.0 Early Access Now Open!"
date: "2026-03-17"
categories:
  - "announcements"
author: "TPEN Team"
...
tldr: |
  **🚀 TPEN 3.0 Early Access is live!**
  ...
  - Interfaces will remain stable for two months
  - Feedback invited via built-in tools, GitHub, and email
...
- **Active Feedback Channels:** Use the built-in bug report and feature request tools in the interface, or reach out directly via [GitHub Issues](https://github.com/CenterForDigitalHumanities/TPEN3/issues) or email (see the About page).
